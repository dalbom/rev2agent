...
**Global rule (applies to all phases):** LLMs hallucinate ~30% of citations. NEVER write BibTeX from memory. Every reference must be web-verified against DBLP / Semantic Scholar / publisher before inclusion. See Phase 7 Step 4.1 for the full verification procedure.
...
- `verify_citations_bibtex.py` — BibTeX DOI verification + hallucination detection
